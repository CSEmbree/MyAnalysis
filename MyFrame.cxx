...
void MyFrame::DrawFrame2(TPad* p){
  ...
  cout<<"TEST: DrawFrame2: displayOverlay="<<(m_draw1? "y":"n")<<", displayRatio="<<(m_draw2?"y":"n")<<endl;
 ...
 // TCanvas* draw_canv =0;
  ...
  //m_subpad1 = new TPad(csubname1.Data()," ",m_sxmin,m_symin,m_sxmax,m_symax);
  //m_subpad1 = new TPad(csubname1.Data()," ",m_sxmin,m_symin,m_sxmax,m_symax); //TEST
  m_subpad1 = new TPad(csubname1.Data()," ", xl1, yl1, xh1, yh1); //TEST
  m_subpad1->SetFillColor(0);
  m_subpad1->SetLeftMargin(m_lm);
 //subpad1->SetLeftMargin(0.25);
  m_subpad1->SetRightMargin(m_rm);
  ...
  //double xl1 = m_sxmin, yl1 = m_symin, xh1 = m_sxmax, yh1 = m_symax;
  //double xl2 = m_sxmin, yl2 = m_s0, xh2 = m_sxmax, yh2 = m_symax;

  TString csubname2="subpad1"; 
  csubname2+=cname;
  //m_subpad2 = new TPad(csubname2.Data()," Ratio ",m_sxmin,m_s0,m_sxmax,m_symin); //orig
  //m_subpad2 = new TPad(csubname2.Data()," Ratio ",m_sxmin,m_s0,m_sxmax,m_symax); //TEST
  m_subpad2 = new TPad(csubname2.Data()," Ratio ", xl2, yl2, xh2, yh2); //TEST
  m_subpad2->SetFillColor(0);
  m_subpad2->SetLeftMargin(m_lm);
  m_subpad2->SetRightMargin(m_rm);
  //m_subpad2->SetBottomMargin(m_bm);
  if( m_draw1 && m_draw2 ) m_subpad2->SetTopMargin(m_small);
  //m_subpad2->SetTopMargin(m_bm); //TEST
